...
public final class PlayingCard implements Card {
     ...
     */
    public enum Compare implements Comparator<PlayingCard> {
        /**
        ...
        ;
        private final Comparator<PlayingCard> comp;

        private Compare() {
            comp = Comparator.naturalOrder();
        }

        private Compare(final Comparator<PlayingCard> comp) {
            this.comp = comp;
        }

        @Override
        public int compare(final PlayingCard o1, final PlayingCard o2) {
